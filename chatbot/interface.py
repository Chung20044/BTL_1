...
# Import hàm chat từ file khác
from Chat import chat

class SimpleChatApp:
    def __init__(self, master):
        self.master = master
        master.title("Chatbot GERTY")
        # master.config(bg="#4B0082")
        ...
        self.chat_display.tag_configure("user_tag", foreground="black")
        self.chat_display.tag_configure("bot_tag", foreground="purple")
    ...
    def display_chatbot_message(self, message):
        ...
        self.chat_display.insert(tk.INSERT, "GERTY: " + message + "\n\n", "bot_tag")
